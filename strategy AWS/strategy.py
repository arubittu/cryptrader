...
#----------------
    ...
    goog_data = pandas_df #pd.read_csv(pricedatabase) 
    #3 moving average
    # fast wala
...
if __name__=='__main__':
    ...
    plt.scatter(goog_data[goog_data.Buy>0].index ,goog_data[goog_data.Buy>0].price , color='green' , marker='^' , alpha=1)
    plt.scatter(goog_data[goog_data.Sell>0].index ,goog_data[goog_data.Sell>0].price , color='red' , marker='v' , alpha=1)
    plt.show()
    print(goog_data['Buy'])
    print(goog_data['Sell'])
